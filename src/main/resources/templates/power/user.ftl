            ...
            jQuery("#list2").jqGrid(
                {
                    ...
                    emptyrecords: "当前无记录",
                    colNames: ['ID', '姓名', '密码', '手机号', '备注', '拥有角色'],//jqGrid的列显示名字
                    colModel: [  //这里会根据index去解析jsonReader中root对象的属性，填充cell
                        ...
                        {name: 'mobile', index: 'mobile', width: 180, sortable: false, search: false},
...
<div id="addeditformdivid" hidden="" class="layui-fluid" style="margin: 15px;">
    <form class="layui-form" action="" id="addeditformid">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="mobile" name="mobile" autocomplete="off" placeholder="请输入手机号"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
