...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            <a href="${basePath!}/welcome" class="logo">智慧校园</a>
            <!-- 显示/隐藏菜单 -->
            ...
            <#--                            &lt;#&ndash;使用freemarker从session中获得一级菜单列表&ndash;&gt;-->
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${basePath!}/static/logo2.png" class="layui-nav-img userAvatar"
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="${basePath!}/user/logout" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a>
                        </dd>
                    </dl>
                </li>
            </ul>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="${basePath!}/static/logo2.png" class="userAvatar"></a>
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="${basePath!}/static/page/main.html"><i class="layui-icon"
                                                                                            data-icon=""></i><cite>首页</cite></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2020 i'm a coder</span></p>
    </div>
</div>
