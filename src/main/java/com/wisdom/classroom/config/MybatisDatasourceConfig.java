package com.wisdom.classroom.config;
...
@MapperScan(basePackages = "com.wisdom.classroom.mapper", markerInterface = MyMapper.class, sqlSessionFactoryRef = "sqlSessionFactory")
