...
public class MenuController {
    ...
    public Map<String, Object> selectMenuById(Integer id) {
        ...
        try {
            if (id == null || id == 0) {
                ...
                WisdomMenu tmenu = wisdomMenuService.selectByKey(id);
                if (tmenu == null) {
                    resultmap.put("state", "fail");
    ...
    @RequiresPermissions(value = {"菜单管理"})
    public Map<String, Object> addupdatemenu(HttpSession session, WisdomMenu tmenu) {
        LinkedHashMap<String, Object> resultmap = new LinkedHashMap<String, Object>();
        try {
            if (tmenu.getId() == null) {//新建
                ...
                if (tmenu.getpId() == null || tmenu.getpId() == 0) {
                    ...
                    WisdomMenu pmenu = wisdomMenuService.selectByKey(tmenu.getpId());//父节点对象
                    if (pmenu.getState() == 3) {
                        resultmap.put("state", "fail");
                    ...
                    List<WisdomMenu> list = wisdomMenuService.selectByExample(example);
                ...
                if (menulist.size() > 0
                    ...
                    WisdomMenu tmenuNew = new WisdomMenu();
                    ...
                    wisdomMenuService.updateNotNull(tmenuNew);
                }
    ...
    @RequiresPermissions(value = {"菜单管理"})
    public Map<String, Object> deletemenu(HttpSession session, WisdomMenu tmenu) {
        LinkedHashMap<String, Object> resultmap = new LinkedHashMap<String, Object>();
        try {
            if (tmenu.getId() != null && !tmenu.getId().equals(0)) {
                WisdomMenu menu = wisdomMenuService.selectByKey(tmenu.getId());
                if (menu == null) {
                    resultmap.put("state", "fail");
                    ...
                    if (true) {
                        ...
                        wisdomMenuService.deleteByExample(tmenuexample);
                    }
                    //删除该节点
                    wisdomMenuService.delete(tmenu.getId());
